	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		*/
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -3.0f));
		model = glm::translate(model, glm::vec3(0.0f, 2.53f, -4.0f));
		model = glm::scale(model, glm::vec3(2.3f, 1.5f, 2.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.0f, 1.0f); // azul
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMeshGeometry(); // pirámide cuadrangular

		// Ventana trasera (esfera azul)
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -3.0f));
		model = glm::translate(model, glm::vec3(0.0f, 0.6f, -5.01f)); 
		...
		// Ventana izquierda frente (cubo)
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -3.0f));
		model = glm::translate(model, glm::vec3(-0.4f, 1.15f, -3.009f));
		model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.1f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		// Ventana izquierda lado izquierdo (cubo)
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -3.0f));
		model = glm::translate(model, glm::vec3(-0.86f, 1.15f, -4.5f));
		model = glm::scale(model, glm::vec3(0.35f, 0.5f, 0.4f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 1.0f, 0.0f); // verde
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh(); // cubo

		// Ventana derecha lado izquierdo (cubo)
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -3.0f));
		model = glm::translate(model, glm::vec3(-0.86f, 1.15f, -3.5f));
		model = glm::scale(model, glm::vec3(0.35f, 0.5f, 0.4f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 1.0f, 0.0f); // verde
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		// Ventana izquierda lado derecho (cubo)
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -3.0f));
		model = glm::translate(model, glm::vec3(0.86f, 1.15f, -4.5f));
		model = glm::scale(model, glm::vec3(0.35f, 0.5f, 0.4f));
		...
		// Ventana derecha lado derecho (cubo)
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -3.0f));
		model = glm::translate(model, glm::vec3(0.86f, 1.15f, -3.5f));
		model = glm::scale(model, glm::vec3(0.35f, 0.5f, 0.4f));
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -3.0f));
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -3.009f));
		model = glm::scale(model, glm::vec3(0.5f, 0.9f, 0.1f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 1.0f, 0.0f); // verde
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh(); // cubo

		// Árbol izquierdo (cilindro)
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -3.0f));
		model = glm::translate(model, glm::vec3(-2.8f, -0.14f, -4.0f));
		model = glm::scale(model, glm::vec3(0.28f, 0.6f, 0.28f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.45f, 0.30f, 0.15f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -3.0f));
		model = glm::translate(model, glm::vec3(-2.8f, 0.55f, -4.0f)); // copa
		model = glm::scale(model, glm::vec3(0.2f, 1.0f, 0.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.55f, 0.15f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[3]->RenderMeshGeometry(); // cono

		// Árbol derecho (cilindro)
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -3.0f));
		model = glm::translate(model, glm::vec3(2.8f, -0.14f, -4.0f)); 
		model = glm::scale(model, glm::vec3(0.28f, 0.6f, 0.28f));
