...
int main()
{
	...
	unsigned int pointLightCount = 0;
						...
						////Declaración del primer arreglo de luces spotlight
						//pointLights[0] = PointLight(0.0f, 1.0f, 0.0f,    // Verde
						//	0.7f, 0.7f,                                // Intensidades
						//	-10.0f, 1.5f, -15.0f,                         // Posición
						//	0.3f, 0.2f, 0.1f);                        // Atenuación
						//pointLightCount++;
						//pointLights[1] = PointLight(0.0f, 0.0f, 1.0f,    // Azul
						//	1.0f, 1.0f,
						//	-3.0f, 1.5f, -15.0f,
						//	0.3f, 0.2f, 0.1f);
						//pointLightCount++;
						//pointLights[2] = PointLight(1.0f, 0.0f, 0.0f,    // Roja
						//	1.0f, 1.0f,
						//	4.0f, 1.5f, -15.0f,
						//	0.3f, 0.2f, 0.1f);
						//pointLightCount++;
						//pointLights[3] = PointLight(1.0f, 1.0f, 1.0f,    // Blanca
						//	1.0f, 1.0f,
						//	15.0f, 1.5f, -15.0f,
						//	0.3f, 0.2f, 0.1f);
						//pointLightCount++;
						...
						//pointLights2[0].SetPos(glm::vec3(-10.0f, 1.5f, -15.0f));
						//pointLights2[1] = pointLights[0];
						//pointLights2[1].SetPos(glm::vec3(-3.0f, 1.5f, -15.0f));
						//pointLights2[2] = pointLights[1];
						//pointLights2[2].SetPos(glm::vec3(4.0f, 1.5f, -15.0f));
						//pointLights2[3] = pointLights[2];
						//pointLights2[3].SetPos(glm::vec3(15.0f, 1.5f, -15.0f));
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//shaderList[0].SetPointLights(pointLights, pointLightCount); //Para mandar todas las luces puntuales
					...
					//if (mainWindow.getprendida()) //Si la bandera es true
					//{
						//if (mainWindow.getlucespuntuales() < 0.5f)		//Se mandan 4 luces puntuales
						//{
							//Se envia al shader el arrelgo de luces puntuales
							//shaderList[0].SetPointLights(pointLights, pointLightCount); // Usar set 1
						//	//printf("Primer set de luces puntuales\n");
						//}
						//else {											//Se mandan 4 luces puntuales
						//	shaderList[0].SetPointLights(pointLights2, pointLightCount); // Usar set 2
						//	//printf("Segundo set de luces puntuales\n"); 
						//}
					//}
					//else
					//{
						//if (mainWindow.getlucespuntuales() < 0.5f)		//Se mandan 3 luces puntuales
						//{
							//shaderList[0].SetPointLights(pointLights, pointLightCount-1); // Usar set 1
						//}
						//else {											//Se mandan 3 luces puntuales
						//	shaderList[0].SetPointLights(pointLights2, pointLightCount-1); // Usar set 2
						//}
					//}

		if (mainWindow.getprendida()) //Si la bandera es true
		{
			//Se envia al shader el arreglo de luces puntuales
			shaderList[0].SetPointLights(pointLights, pointLightCount); // Lumninaria prendida
		}
		else
		{
			//NO se envia la ultima luz puntual (luz de la lampara)
			shaderList[0].SetPointLights(pointLights, pointLightCount - 1); // Luminaria apagada
		}
		...
		modelaux = model;
		spotLights[2].SetPos(glm::vec3(modelaux[3].x - 6.0f, modelaux[3].y - 0.7f, modelaux[3].z - 2.2f)); //posicion de la linterna con jerarquia
		...
		spotLights[3].SetPos(glm::vec3(model[3].x, model[3].y - 1.0f, model[3].z));   //posicion de la luz del helicoptero
		...
		pointLights[1].SetPos(glm::vec3(model[3].x, model[3].y + 8.0f, model[3].z)); //posicion de la luz de la lampara
