...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::rotate(model, glm::radians(135.0f), glm::vec3(0.0f, 0.0f, 1.0f)); //rotación alrededor de la articulación que une con la cabina
		...
		//Cuarta articulación
		model = modelaux; // transformación acumulada del brazo 3
		model = glm::translate(model, glm::vec3(0.0f, -2.5f, 0.0f)); // posición de articulación 4
